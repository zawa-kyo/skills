...
1. Review the conversation and identify the assumptions that shape the request.
2. Inspect the available code, documents, tools, or environment and verify those assumptions. Find facts yourself when you can.
