...
zawa-kyo が管理する再利用可能なエージェントスキル集です。[apm](https://github.com/microsoft/apm) 経由で配布します。

`meta/` 配下の各ディレクトリは、それぞれ独立したスキルです。
...
| Cleanup English Writing | `meta/cleanup-english-writing` | 技術的な意味を保ったまま、英語の技術文書を直接的で人間らしく、AI っぽさの少ない文章に整える。      |
