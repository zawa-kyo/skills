...
description: Build an automated verification strategy when the appropriate method or test level is unclear, the work spans unit, integration, and E2E boundaries, or the user wants portfolio analysis. Inspect product risks and production context before choosing how to verify them. Delegate work that clearly belongs to a unit, integration, or E2E specialist, and reason directly about other verification approaches without forcing them into those three labels. Use this skill for cross-level design and boundary selection, test portfolio review, or challenging a requested test level. It does not cover framework setup, CI configuration, performance testing, security testing, or exploratory testing in detail.
---
...
Own decisions that precede or span test levels:
...
- how confidence, diagnosis, execution frequency, and creation and maintenance cost trade off
- which risks remain with another test, control, or intentional gap
...
5. Choose the approach or combination that provides the best value for the stated priorities.
...
7. Delegate work that clearly matches a specialist. Handle other outcomes directly without inventing a new taxonomy or forcing a three-level label.
...
If the work does not clearly fit one of these specialists, keep the decision here and reason from the inspected context.
