...
| UT-OBS-001 | 実装詳細より、観察可能な結果を優先して検証する。                           | Observation      | Essential   | `references/observation-and-oracles.md` | 検証方法を選ぶ場面。           | 境界依存との相互作用は mock が必要になることがある。         | Khorikov | Adopted | 初期ルール。 |
